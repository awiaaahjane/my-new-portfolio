...
const shapes = [
  ...
  },
  {
    width: 1011,
    height: 594,
    path: 'M3.9147 425.924L127.719 43.3729C135.894 18.1125 159.419 1 185.969 1H909.238C949.486 1 978.786 39.1707 968.381 78.0509L866.01 460.603C858.845 487.378 834.585 506 806.867 506H62.1644C20.6007 506 -8.88298 465.469 3.9147 425.924Z',
  },
  {
    width: 719,
    height: 680,
...
export function StylizedImage({
  ...
  return (
    <div
      className={clsx(
        className,
        'relative flex aspect-[719/680] w-full grayscale duration-1000 hover:grayscale-0',
      )}
    >
